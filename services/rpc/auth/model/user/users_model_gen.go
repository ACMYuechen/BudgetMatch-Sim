...
type (
	...
	Users struct {
		...
		Role      int            `json:"role" gorm:"type:int;default:100;comment:角色, 100为普通用户, 详情见infra/role"`
		Status    int            `json:"status" gorm:"type:int;default:1;comment:状态，1:启用 2:禁用 3:待注销 4:已注销"`
