...
const (
	...
	AuthService_CheckUsername_FullMethodName = "/auth.AuthService/CheckUsername"
)
...
func (c *authServiceClient) CheckUsername(ctx context.Context, in *CheckUsernameReq, opts ...grpc.CallOption) (*CheckUsernameResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServiceServer) CheckUsername(context.Context, *CheckUsernameReq) (*CheckUsernameResp, error) {
...
func _AuthService_CheckUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CheckUsername(ctx, req.(*CheckUsernameReq))
	}
	return interceptor(ctx, in, info, handler)
}
