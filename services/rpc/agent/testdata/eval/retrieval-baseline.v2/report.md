...
- 代码标记：ba9e0ed+M4.1a-worktree（调用者提供，不是签名认证）。
...
| vector_first | 10/8 | 16/20（80.00%） | 16/40（40.00%） | 0.722701（8 例） | 1/2（50.00%） | 2/10 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| keyword_only | 18/18（100.00%） | 0 | 25/0 | 0/0 | 0.0691/1.3922 |
| vector_only | 18/18（100.00%） | 0 | 0/24 | 0/0 | 0.0326/0.2921 |
| vector_first | 18/18（100.00%） | 0 | 6/18 | 6/2 | 0.0048/0.0693 |
| hybrid_rrf | 18/18（100.00%） | 0 | 22/21 | 0/3 | 0.0508/1.8461 |
...
| vector_first | complementary_lanes, keyword_exact, duplicate_ranks | vector_alias, consensus_noise | consensus_match, filtered_prefix, missing_relevant |
...
| filtered_prefix | quality | vector_first | ok/ok | k1, k2, k3, k4 | 4/4 | keyword:16, vector:8 |  |
