...
type ConfirmPaymentResp struct {
	...
	AlreadyConfirmed bool                   `protobuf:"varint,3,opt,name=already_confirmed,json=alreadyConfirmed,proto3" json:"already_confirmed,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ConfirmPaymentResp) GetAlreadyConfirmed() bool {
	if x != nil {
...
const file_services_rpc_mall_proto_mall_proto_rawDesc = "" +
	...
	"outTradeNo\x12\x19\n" +
	"\btrade_no\x18\x05 \x01(\tR\atradeNo\"s\n" +
	"\x12ConfirmPaymentResp\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06status\x12+\n" +
	"\x11already_confirmed\x18\x03 \x01(\bR\x10alreadyConfirmed\"\\\n" +
