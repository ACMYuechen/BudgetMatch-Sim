...
核对日期：2026-09-16；Agent 相关增量更新至 2026-09-20 M6.3a1（含流式 RPC/HTTP/前端身份、分段预算、日志、隔离真实存储与恢复验收，以及显式开发库联调工具边界）。范围：`cmd/app`、`cmd/admin` 和当前 RPC 服务。
