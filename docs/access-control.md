...
核对日期：2026-09-16；Agent 相关增量更新至 2026-09-20 M6.3b 本机 Flash 真实流式与取消验收（含模型限额、流式 RPC/HTTP/前端身份、分段预算、日志、隔离真实存储与恢复、真实登录与浏览器验收，以及显式开发库联调和只读复查边界）。范围：`cmd/app`、`cmd/admin` 和当前 RPC 服务。
